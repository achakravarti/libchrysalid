...
extern CY_PSAFE bool            cy_cfg_bool(const cy_cfg_t *);
extern CY_PSAFE long            cy_cfg_int(const cy_cfg_t *);
extern CY_PSAFE double          cy_cfg_flt(const cy_cfg_t *t);
extern CY_SAFE const char      *cy_cfg_str(const cy_cfg_t *);
extern CY_SAFE cy_utf8_t       *cy_cfg_print(const cy_cfg_t *);
