...
ifdef(<<<MAN>>>,
<<<% LIBCHRYSALIS:C_HEAP_SIZE_SET_(3) libchrysalis 0.0.1
%
% 2022>>>)


__NAME__(<<<c_heap_size_set_>>>)

`c_heap_size_set_` - marks a function as immutable


__SYNOPSIS__(<<<c_heap_size_set_>>>)
